...
**File**: `bt-strategy-test/binomial_regression/verify_slope_calculation.py`
...
**File**: `bt-strategy-test/binomial_regression/verify_forward_outcomes.py`
...
**File**: `bt-strategy-test/binomial_regression/analyze_hit_timing.py`
...
**File**: `bt-strategy-test/binomial_regression/add_volatility_filters.py`
...
**File**: `bt-strategy-test/binomial_regression/analyze_time_context.py`
...
**File**: `bt-strategy-test/binomial_regression/optimize_quality_vol_filter.py`
