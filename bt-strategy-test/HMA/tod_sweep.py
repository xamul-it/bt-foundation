...
Uso:
    python bt-strategy-test/HMA/tod_sweep.py
    python bt-strategy-test/HMA/tod_sweep.py --period 8 --exitbar 6
    python bt-strategy-test/HMA/tod_sweep.py --symbols CSCO NFLX KHC
    python bt-strategy-test/HMA/tod_sweep.py --from 2025-01-01 --to 2025-03-31
    python bt-strategy-test/HMA/tod_sweep.py --out /tmp/tod_detail.csv
"""
import sys
