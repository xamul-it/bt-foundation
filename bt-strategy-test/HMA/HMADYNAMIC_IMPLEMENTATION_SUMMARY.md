...
2. `bt-strategy-test/HMA/HMADYNAMIC_STRATEGY_GUIDE.md` (800 lines)
3. `bt-strategy-test/HMA/HMADYNAMIC_IMPLEMENTATION_SUMMARY.md` (this file)
4. `bt-strategy-test/HMA/test_hmadynamic_load.py` (test script)
