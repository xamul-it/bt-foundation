...
Uso:
    python bt-strategy-test/HMA/overnight_analysis.py
    python bt-strategy-test/HMA/overnight_analysis.py --symbols NFLX CSCO
    python bt-strategy-test/HMA/overnight_analysis.py --from 2025-01-02 --to 2025-05-30
"""
import sys
