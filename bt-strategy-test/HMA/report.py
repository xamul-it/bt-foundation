...
Uso:
    python bt-strategy-test/HMA/report.py
    python bt-strategy-test/HMA/report.py --symbols NFLX PLTR --from 2025-01-01 --to 2025-03-31
    python bt-strategy-test/HMA/report.py --out /tmp/hma_report.html --no-llm
