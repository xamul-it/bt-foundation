...
**Comando di test**:
```python
# In bt-strategy-test/HMA/06-hma_limit_order_optimization.py
...
**Analisi**:
- `bt-strategy-test/HMA/debug_backtrader_signals.py` - Debug script ATR filter
- `bt-strategy-test/HMA/analyze_optimal_period_per_symbol.py` - Period optimization (con bug)

**Risultati**:
- `bt-strategy-test/HMA/period_optimization_analysis/` - Risultati period test (non attendibili)

**Documentazione**:
- `bt-strategy-test/HMA/CRITICAL_BUG_FIX_SIGNAL_LOGIC.md` - Fix signal detection
- `bt-strategy-test/HMA/PERIOD_OPTIMIZATION_HYPOTHESIS.md` - Ipotesi teoriche
- `bt-strategy-test/HMA/PERIOD_OPTIMIZATION_CRITICAL_FINDINGS.md` - Bug ATR identificato
- `bt-strategy-test/HMA/FINAL_STATUS_PERIOD_OPTIMIZATION.md` - Questo documento
