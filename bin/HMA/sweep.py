...
Uso:
    python bin/HMA/sweep.py
    python bin/HMA/sweep.py --symbols CSCO NFLX KHC
    python bin/HMA/sweep.py --periods 8 12 16 20 --exitbars 4 6 8 10
    python bin/HMA/sweep.py --from 2025-01-01 --to 2025-03-31
    python bin/HMA/sweep.py --out /tmp/hma_sweep.csv
    python bin/HMA/sweep.py --detail        # mostra anche righe per simbolo
"""
import sys
