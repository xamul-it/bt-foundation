...
#
# Uso:
#   bash bin/HMA/validate_sl.sh
#   bash bin/HMA/validate_sl.sh --from 2025-01-01 --to 2025-03-31
# ──────────────────────────────────────────────────────────────────────────────
set -euo pipefail
...
echo ""
echo "  python bin/HMA/compare.py --bt-dir $BT_CORE/out/intraday/HMA/<run_id>"
echo ""
