...
Script: `bin/hma/sweep1_period_exitbar.sh`
...
Script: `bin/hma/sweep2_finegrained.sh`
...
Script: `bin/hma/sweep3_sl_tp_atr.sh`
...
|--------|--------|-------------|
| `bin/hma/sweep1_period_exitbar.sh` | `out/intraday/HMA/tuning2/` | Grid period×exitbar |
| `bin/hma/sweep2_finegrained.sh`    | `out/intraday/HMA/tuning3/` | Fine-grained intorno a p14_eb6 |
| `bin/hma/sweep3_sl_tp_atr.sh`      | `out/intraday/HMA/tuning4/` | SL / TP / ATR filter |
