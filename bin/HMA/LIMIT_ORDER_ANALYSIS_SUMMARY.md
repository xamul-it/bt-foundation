...
### Analysis Scripts
- `bin/HMA/06-hma_limit_order_optimization.py` - Limit order testing framework

### Results Data
- `bin/HMA/limit_order_analysis/market.csv` - Market order results (baseline)
- `bin/HMA/limit_order_analysis/limit_close.csv` - Limit at close results (WINNER)
- `bin/HMA/limit_order_analysis/limit_next_open.csv` - Next bar open fills
- `bin/HMA/limit_order_analysis/limit_next_open_10bp.csv` - Next open with 10bp offset
- `bin/HMA/limit_order_analysis/limit_next_range.csv` - Next bar range fills
- `bin/HMA/limit_order_analysis/limit_next_range_10bp.csv` - Next range with 10bp offset
- `bin/HMA/limit_order_analysis/limit_next_range_20bp.csv` - Next range with 20bp offset
- `bin/HMA/limit_order_analysis/limit_order_summary.csv` - Complete comparison

### Documentation
- `bin/HMA/LIMIT_ORDER_ANALYSIS_SUMMARY.md` - This file
- `bin/HMA/COMPLETE_ANALYSIS_SUMMARY.md` - Full HMA journey
- `bin/HMA/FILTER_ANALYSIS_SUMMARY.md` - Filter optimization results
- `bin/HMA/VALIDATION_METHODOLOGY.md` - Out-of-sample validation approach
