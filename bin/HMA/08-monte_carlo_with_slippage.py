...
def main():
    ...
    OUTPUT_DIR = Path('bin/HMA/monte_carlo')
    ...
    # Load trade results
    limit_trades = pd.read_csv('bin/HMA/limit_order_analysis/limit_close.csv')
    market_trades = pd.read_csv('bin/HMA/limit_order_analysis/market.csv')
