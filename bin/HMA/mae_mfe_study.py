...
Uso:
    python bin/HMA/mae_mfe_study.py
    python bin/HMA/mae_mfe_study.py --period 8 --lookbacks 4 6 8 10 16
    python bin/HMA/mae_mfe_study.py --symbols CSCO NFLX KHC
    python bin/HMA/mae_mfe_study.py --out /tmp/mae_mfe.csv
"""
import sys
