...
Uso:
    ...
    python bin/HMA/compare.py --bt-dir out/intraday/HMA/sim

    # Tre fonti (pandas + BT + paper):
    python bin/HMA/compare.py --bt-dir out/intraday/HMA/sim --paper-dir out/intraday/HMA/paper

    # Filtra su un simbolo:
    python bin/HMA/compare.py --bt-dir out/intraday/HMA/sim --symbol NFLX
