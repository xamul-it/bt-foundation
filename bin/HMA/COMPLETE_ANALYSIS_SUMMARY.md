...
### Analysis Scripts
- `bin/HMA/01-hma_backtest.py` - Initial backtest with close-and-revert logic
- `bin/HMA/02-hma_period_optimization.py` - Period parameter optimization
- `bin/HMA/03-hma_timeframe_analysis.py` - Multi-timeframe testing (fractal theory)
- `bin/HMA/04-hma_filter_optimization.py` - Quality filter optimization
- `bin/HMA/05-hma_atr_threshold_optimization.py` - ATR threshold grid search
...
- `bin/HMA/COMPLETE_ANALYSIS_SUMMARY.md` - This file (complete journey)
