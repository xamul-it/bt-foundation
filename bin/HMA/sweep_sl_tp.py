...
Uso:
    python3 bin/hma/sweep_sl_tp.py
    python3 bin/hma/sweep_sl_tp.py --samples 100 --seed 42
    python3 bin/hma/sweep_sl_tp.py --optimistic    # TP-first come 01-hma_backtest.py
    python3 bin/hma/sweep_sl_tp.py --no-atr        # SL×TP×time (senza ATR)
    python3 bin/hma/sweep_sl_tp.py --no-time       # SL×TP×ATR (senza time filter)
    python3 bin/hma/sweep_sl_tp.py --no-atr --no-time  # solo SL×TP (24 combo)
"""
